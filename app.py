...
def render_history_sidebar():
    with st.sidebar:
        st.markdown('<div style="font-size:18px;font-weight:700;color:#E1E8F0;margin-bottom:6px;letter-spacing:0.02em">⬡ Nexus AI</div>'
                    '<div style="font-size:11px;color:#5A6A7A;letter-spacing:0.05em;margin-bottom:24px;font-weight:600">MULTI-MODEL DISCUSSIONS</div>',unsafe_allow_html=True)
